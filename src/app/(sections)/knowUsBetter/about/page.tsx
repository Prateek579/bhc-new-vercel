      ...
      <div className="max-w-screen-2xl mx-auto px-3 sm:px-6 md:px-8 lg:px-22">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-lg border-1 border-gray-300 flex flex-col items-center justify-center min-h-[180px] md:min-h-[220px] group hover:bg-gradient-to-r hover:from-[#18A093] hover:to-[#003366] transition-all duration-300">
            ...
            <h3 className="text-2xl font-[700] font-['Montserrat'] leading-[100%] tracking-[0%] text-[#333333] group-hover:text-white align-middle mb-4 text-center w-full transition-colors duration-300">Academics & Researchers</h3>
          ...
          <div className="bg-white p-8 rounded-lg border-1 border-gray-300 flex flex-col items-center justify-center min-h-[180px] md:min-h-[220px] group hover:bg-gradient-to-r hover:from-[#18A093] hover:to-[#003366] transition-all duration-300">
            ...
            <h3 className="text-2xl font-[700] font-['Montserrat'] leading-[100%] tracking-[0%] align-middle text-[#333333] group-hover:text-white mb-4 text-center w-full transition-colors duration-300">Industry Professionals & Entrepreneurs</h3>
            <p className="text-sm font-['Montserrat'] sm:text-base md:text-lg text-gray-600 group-hover:text-white text-center transition-colors duration-300">
          ...
          <div className="bg-white p-8 rounded-lg border-1 border-gray-300 flex flex-col items-center justify-center min-h-[180px] md:min-h-[220px] group hover:bg-gradient-to-r hover:from-[#18A093] hover:to-[#003366] transition-all duration-300">
            ...
            <h3 className="text-2xl font-[700] font-['Montserrat'] leading-[100%] tracking-[0%] align-middle text-[#333333] group-hover:text-white mb-4 text-center w-full transition-colors duration-300">Hospitals & NGO Collaborators</h3>
            <p className="text-sm font-['Montserrat'] sm:text-base md:text-lg text-gray-600 group-hover:text-white text-center transition-colors duration-300">
